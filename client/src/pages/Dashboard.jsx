        ...
        <div className="p-3 lg:p-6 space-y-4 max-w-7xl mx-auto w-full pb-24">
            ...
            <section className="flex flex-col lg:flex-row lg:items-end justify-between gap-2 px-1">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                    <h1 className="text-2xl lg:text-4xl font-black text-indigo-900 tracking-tighter">Academic Overview</h1>
            ...
            <motion.div 
                ...
                className="bg-gradient-to-br from-primary to-primary-container rounded-[1.5rem] p-4 lg:p-6 text-white relative overflow-hidden shadow-sm shadow-indigo-900/5 w-full"
            >
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div>
                        ...
                        <h3 className="text-4xl lg:text-5xl font-black tracking-tighter flex items-end">
                            {loading ? '---' : stats.percentage}<span className="text-primary-fixed text-xl lg:text-2xl mb-1 ml-1">%</span>
                        </h3>
                        <p className="text-indigo-100 font-medium text-xs lg:text-sm mt-1 opacity-90">Subject-wise Attendance</p>
                    </div>
                    <div className="flex items-center gap-4 border-t border-white/20 pt-3 lg:border-t-0 lg:pt-0">
                        <div>
